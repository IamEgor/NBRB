...
package com.example.yegor.materialdaterangepicker.date;
...
import com.example.yegor.materialdaterangepicker.HapticFeedbackController;
import com.example.yegor.materialdaterangepicker.R;
import com.example.yegor.materialdaterangepicker.TypefaceHelper;
import com.example.yegor.materialdaterangepicker.Utils;
...
public class DatePickerDialog extends DialogFragment implements
    ...
    AccessibleDateAnimator mAnimator;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        okButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utils.daysBetween(mCalendar, mCalendarEnd) > 365) {
                    Toast.makeText(getActivity(), R.string.loo_large_range, Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        tabHost.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String tabId) {
                ...
                boolean isStartPage = tabId == "start";
                onTabChanged.onTabChanged(DatePickerDialog.this, mCalendar, mCalendarEnd, isStartPage);
    ...
    public void show(FragmentManager manager, String tag, Calendar start, Calendar end) {
        mCalendar = start;
        mCalendarEnd = end;
        show(manager, tag);
    }
    ...
    public interface OnTabChanged {
        void onTabChanged(DatePickerDialog dialog, Calendar calendarStart, Calendar calendarEnd,
                          boolean isStartPage);
    }
}
